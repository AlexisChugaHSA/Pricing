...
import ExpandedOrderRowCModelos from './expanded-row';
// dynamic import
...
export default function TableComparativaModelos({
  data = [],
  variant = 'modern',
  className,
}: {
    ...
    <div className={cn(className)}>
      <ControlledTable
        ...
        expandable={{
          ...
          expandedRowRender: (record) => <ExpandedOrderRowCModelos record={record} />,
        }}
        paginatorOptions={{
          pageSize,
          setPageSize,
